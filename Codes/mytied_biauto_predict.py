...
f1=open("mytied_encoder_biauto_han_unit100_batch100_pred_train.txt",'w')
f2=open("mytied_encoder_biauto_han_unit100_batch100_pred_val.txt",'w')
f3=open("mytied_encoder_biauto_han_unit100_batch100_pred_test.txt",'w')
