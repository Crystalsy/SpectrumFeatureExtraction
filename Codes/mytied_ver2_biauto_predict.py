...
with tf.device("/device:GPU:1"):
    ...
    X_hat_test=[]
    for j in range(30):
	model_name="mytied_encoder_biauto_ver2_hidden100_"+str(j)+".h5"
	for i in range(batch_size):
	    K.clear_session()
	    with tf.device("/device:GPU:1"):
...
f1=open("mytied_encoder_biauto_ver2_han_unit100_batch100_pred_train.txt",'w')
f2=open("mytied_encoder_biauto_ver2_han_unit100_batch100_pred_val.txt",'w')
f3=open("mytied_encoder_biauto_ver2_han_unit100_batch100_pred_test.txt",'w')
